             ...
             float *outColIdxSorted)
{
    ...
    // NOTE: I currently have some issues linking cusparse during compilation. The function cusparseSgthr does not seem to load correctly, so simply skip here for it is not accessed for now anyways.
...
{
    // But where is this kernel used...?
    // Anyways, dimmedian is not affected I believe...
